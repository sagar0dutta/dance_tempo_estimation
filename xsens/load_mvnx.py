...
import collections
import numpy as np
from xsens.mvnx_file_accessor import MvnxFileAccessor
import xsens.mvn
...
FOOT_CONTACT_MAP = {'LeftFoot_Heel': {'type': 1, 'segment_index': xsens.mvn.SEGMENT_LEFT_FOOT, 'point_index': 2},
                    'LeftFoot_Toe': {'type': 1, 'segment_index': xsens.mvn.SEGMENT_LEFT_TOE, 'point_index': 1},
                    'RightFoot_Heel': {'type': 1, 'segment_index': xsens.mvn.SEGMENT_RIGHT_FOOT, 'point_index': 2},
                    'RightFoot_Toe': {'type': 1, 'segment_index': xsens.mvn.SEGMENT_RIGHT_TOE, 'point_index': 1}}
