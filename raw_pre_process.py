...
import numpy as np
import pandas as pd
from foot_module import onset_calculations as onset_calc
...
class rawDataHandler:
    ...
    def load_and_process_data(self, file_name, mode = 'gr', drum = 'J2', section_idx=0):
        ...
        pickle_path = f'../djembe_collab/motion_data_pkl/{pickle_filename}.pkl'
        ...
        drum_onsets_path = f"../djembe_collab/drum_onsets/{onset_filename}.csv"
        dance_anno_path = f"../djembe_collab/Dataset_V2/{danceanno_filename}.csv"
        mcycle_path = f"../djembe_collab/metric_cycles/{mcycle_filename}.csv"
